                  ...
                  <div class="iq-card">
                     ...
                     <div class="iq-card-body">
                        <div class="new-user-info">
                           <form id="updateLeadForm" method="POST" action="{{ route('update.leads', ['id' => $lead->id]) }}">
                           @csrf
                           @method('PUT')
                              <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="office_number" value="{{$lead->office_phone_number}}" placeholder="" name="office_phone_number" autocomplete="off">
