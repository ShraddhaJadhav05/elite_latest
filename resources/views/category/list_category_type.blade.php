                    ...
                    <div class="table-responsive">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <a class="btn btn-primary" href="{{route('category_type.add')}}" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex align-items-center list-user-action">
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Show" href="{{ route('category_type.view',['id' => $data->id]) }}"><i class="ri-eye-line"></i></a>
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{route('category_type.update',['id' => $data->id])}}"><i class="ri-pencil-line"></i></a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Delete Category Type</h3>
            </div>
            <div class="modal-body">
                <p>Are you sure you want to delete this category type?</p>
            </div>
            <div class="modal-footer">
                <form action="{{route('category_type.delete')}}" method="post">
                    @csrf
