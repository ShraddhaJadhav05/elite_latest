...
@section('admin')
<form id="addLeadForm" method="POST" action="{{ route('category_type.update',['id' => $get_data->id]) }}" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="iq-card-body">
                        <div class="new-user-info">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pname" placeholder="Type" name="type"  value="{{$get_data->type}}" required>
                            </div>
                            <div class="form-group">
