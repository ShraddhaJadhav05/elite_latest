          ...
          <ul id="iq-sidebar-toggle" class="iq-menu">
             ...
             <li>
               ...
               <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                  ...
                  <li><a href="add-user.html"><i class="ri-user-add-line"></i>Create New Client</a></li>     
               </ul>
             </li>
             <li>
             ...
             <li class="active"><a href="{{route('all.enquires')}}" class="iq-waves-effect"><i class="ri-contacts-line"></i><span>Enquires</span></a></li>
                <li>
