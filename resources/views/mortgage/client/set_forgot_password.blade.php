                ...
                <div class="row no-gutters">
                    <div class="col-sm-6 align-self-center">
                        <div class="sign-in-from">
                            ...
                            <form class="mt-4" method="POST" action="{{route('setForgotPassword')}}">
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputEmail1">New Password</label>
                                    <input type="password" class="form-control mb-0" id="exampleInputEmail1" placeholder="Enter new password" name="new_password" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Confirm Password</label>
                                    <input type="password" class="form-control mb-0" id="exampleInputEmail1" placeholder="Enter confirm password" name="confirm_password" required>
                                </div>
