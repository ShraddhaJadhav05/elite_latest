            ...
            <div class="col-lg-6">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <form action="{{route('mortgage.step3')}}" method="post" class="custom-form contact-form" role="form" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="row m-0">
                                <div class="col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="text" name="price" id="price" class="form-control input_radius" required="" data-error="Please enter Price" placeholder="AED 200000">
                                        </div>
                                        <div class="col-md-4 col-6 pad-left">
                                            <span class="input_info">
                                                Pay up front {{$response['down_perc']}}%
                                ...
                                <div class="let-contact-btn mt-3 calc_btn">
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2 w-100 mb-3" style="pointer-events: all; cursor: pointer;">Submit Application</button>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-12">
