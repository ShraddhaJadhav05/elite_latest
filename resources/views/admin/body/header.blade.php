          ...
          <ul class="navbar-list">
              ...
              <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center bg-primary rounded">
                  <img class="profile-pic" src="{{ $adminData->logo ? asset('user_profile/' . $adminData->logo) : asset('adminbackend/assets/images/user/blank.png') }}" alt="profile-pic">
                   <div class="caption">
                      <h6 class="mb-0 line-height text-white" style="margin-left:8px">{{ $adminData->fname }}</h6>
                      <span class="font-size-12 text-white"style="margin-left:8px">Available</span>
                   </div>
                </a>
                <div class="iq-sub-dropdown iq-user-dropdown">
                   <div class="iq-card shadow-none m-0">
                      <div class="iq-card-body p-0 ">
                         <div class="bg-primary p-3">
                            <h5 class="mb-0 text-white line-height">{{ $adminData->fname }}</h5>
                         ...
                         <a href="{{ route('show.reset.password') }}" class="iq-sub-card iq-bg-primary-hover">
                            <div class="media align-items-center">
                               <div class="rounded iq-card-icon iq-bg-primary">
                                  <i class="ri-profile-line"></i>
                               </div>
