    ...
    <div id="sidebar-scrollbar">
       <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
             ...
             <li @if(($data['pageTitle'] ?? null) =='dashboard') class="active"  @endif>
                <a href="index.html" class="iq-waves-effect"><i class="ri-home-4-line"></i><span>Dashboard </span></a>
             </li>
       

             <!-- <li @if(($data['pageTitle'] ?? null)=='Mortgageloans') class="active"  @endif>
               <a href="#leads" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="ri-archive-drawer-line"></i><span>Loans</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
               <ul id="leads" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                   <li><a href="{{ route("all.mortgageplans") }}"><i class="ri-archive-drawer-line"></i>Loans</a></li>
                   <li><a href=""><i class="ri-chat-check-line"></i>Create New Loans</a></li>
               </ul>
            </li> -->

            <li @if(($data['pageTitle'] ?? null)=='Mortgageloans') class="active"  @endif>
               <a href="#leads" class="iq-waves-effect collapsed"  data-toggle="collapse" aria-expanded="false"><i class="ri-archive-drawer-line"></i><span>Mortgage Loans</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
               <ul id="leads" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                   <li><a href="{{ route("all.mortgageplans") }}"><i class="ri-archive-drawer-line"></i>Mortgage Plan</a></li>
                   <li><a href="{{ route("show.mortgageplans") }}"><i class="ri-chat-check-line"></i>Create Mortgage Plan</a></li>
               </ul>
            </li>



             <li @if(($data['pageTitle'] ?? null)=='leads') class="active"  @endif>
             ...
             <!-- <li>
                    <a href="#roles" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false">
                        <i class="ri-user-line"></i><span>Roles & Permissions</span>
                        <i class="ri-arrow-right-s-line iq-arrow-right"></i>
                    </a>
                    <ul id="roles" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="{{route('all.permissions')}}"><i class="ri-file-edit-line"></i>All Permissions</a></li>
                        <li><a href="{{route('show.permissions')}}"><i class="ri-user-add-line"></i>Add Permissions</a></li>
                        <li><a href="{{route('all.roles')}}"><i class="ri-file-list-line"></i>All Roles</a></li>
                        <li><a href="{{route('show.roles')}}"><i class="ri-user-add-line"></i>Add Roles</a></li>
                        <li><a href="{{route('show.roles.permissions')}}"><i class="ri-user-add-line"></i>Roles In Permissions</a></li>    
                    </ul>
                </li> -->
             <li @if(($data['pageTitle'] ?? null) =='clients') class="active"  @endif>
             ...
             <li @if(($data['pageTitle'] ?? null) =='brokers') class="active"  @endif>
             ...
             <li @if(($data['pageTitle'] ?? null) =='banks') class="active"  @endif>
               ...
               <ul id="banks" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                       ...
                       <li><a href="{{route('all.branch')}}"><i class="ri-file-list-line"></i>Branch </a></li>
                       <li><a href="{{route('all.banks_branch')}}"><i class="ri-file-list-line"></i>Bank Branch</a></li>
             ...
             <li @if(($data['pageTitle'] ?? null) =='staff') class="active"  @endif>
             ...
             <li @if(($data['pageTitle'] ?? null) =='appoinment') class="active"  @endif>
             ...
             <li @if(($data['pageTitle'] ?? null) =='enquiry') class="active"  @endif><a href="{{route('all.enquires')}}" class="iq-waves-effect"><i class="ri-contacts-line"></i><span>Enquires</span></a></li>
             <li class="{{ ($firstSegment == 'cms' || $firstSegment == 'blogs' || $firstSegment == 'frontpage') ? 'active' : '' }}">
                  ...
                  <ul id="cms" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                     <li class="{{ $firstSegment == 'frontpage' ? 'active' : '' }}"><a href="{{route('frontpage.blocks')}}"><i class="ri-file-info-line"></i>Frontpage</a></li>
                     <li class="{{ $firstSegment == 'cms' ? 'active' : '' }}"><a href="{{route('cms.pages')}}"><i class="ri-file-edit-line"></i>Pages</a></li>
                     <li><a href="#"><i class="ri-slideshow-line"></i>Slideshow</a></li>
                     <li><a href="#"><i class="ri-file-paper-line"></i>Blocks</a></li>
                     <li class="{{ $firstSegment == 'blogs' ? 'active' : '' }}"><a href="{{route('blogs.list')}}"><i class="ri-file-paper-line"></i>Blogs</a></li>
                  </ul>
               </li>
               <li class="{{ ($firstSegment == 'service') ? 'active' : '' }}">
                  ...
                  <ul id="services" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                     <li class="{{ ($currentRoute == 'service.listServices' || $currentRoute == 'service.viewService' || $currentRoute == 'service.updateService') ? 'active' : '' }}">
                           <a href="{{route('service.listServices')}}"><i class="ri-file-info-line"></i>Services </a>
                     </li>
                     <li class="{{ ($currentRoute == 'service.addService') ? 'active' : '' }}">
                           <a href="{{route('service.addService')}}"><i class="ri-file-list-line"></i>Add New Service</a>
                     </li>
                     <li class="{{ ($currentRoute == 'service.listCategory' || $currentRoute == 'service.addCategory' || $currentRoute == 'service.viewCategory' || $currentRoute == 'service.updateCategory') ? 'active' : '' }}">
                           <a href="{{route('service.listCategory')}}"><i class="ri-slideshow-line"></i>Category</a>
                     </li>
                  </ul>
               </li>
               <li class="{{ ($firstSegment == 'faq' || $firstSegment == 'category') ? 'active' : '' }}">
                  ...
                  <ul id="faq" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                     <li class="{{ ($firstSegment == 'faq' && $currentRoute != 'faq.add' ) ? 'active' : '' }}"><a href="{{route('faq.list')}}"><i class="ri-file-edit-line"></i>FAQs</a></li>
                     <li class="{{ $currentRoute == 'faq.add' ? 'active' : '' }}"><a href="{{route('faq.add')}}"><i class="ri-file-edit-line"></i>Add New FAQ</a></li>
                     <!-- <li><a href="{{route('category_type.list')}}"><i class="ri-file-edit-line"></i>Category Type</a></li> -->
                     <li class="{{ $firstSegment == 'category' ? 'active' : '' }}"><a href="{{route('category.list')}}"><i class="ri-file-edit-line"></i>Category</a></li>
                  </ul>
               </li>
               <li><a href="mortgagecalculator.html" class="iq-waves-effect"><i class="ri-calculator-line"></i><span>Mortgage Calculator</span></a></li>
               <li class="{{ ($firstSegment == 'settings') ? 'active' : '' }}">
                  ...
                  <ul id="settings" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                     <li class="{{( $currentRoute == 'settings.generalSettings' || $currentRoute == 'settings.viewHeader' || $currentRoute == 'settings.updateHeader' ) ? 'active' : '' }}">
                        <a href="{{route('settings.generalSettings')}}">
                        <i class="ri-home-8-line"></i>General </a>
                     </li>
                     <li class="{{( $currentRoute == 'settings.viewSEOAndSMO' || $currentRoute == 'settings.editSEOAndSMO' ) ? 'active' : '' }}">
                        <a href="{{route('settings.viewSEOAndSMO')}}"><i class="ri-file-2-line"></i>SEO & SMO</a>
                     </li>
             ...
             <li @if(($data['pageTitle'] ?? null) =='admin') class="active"  @endif>
               <a href="#admin" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-admin-line"></i><span>Admin</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                  <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                    <li><a href="{{ route('data.userData') }}"><i class="ri-admin-line"></i>Users </a></li>
                    <li><a href="{{ route('roles.all') }}"><i class="ri-file-2-line"></i>Roles</a></li>
                    <li><a href="{{ route('all.permissions') }}"><i class="ri-file-2-line"></i>Permission</a></li>
                    <li><a href="{{ route('all.roles.permissions') }}"><i class="ri-file-2-line"></i>Roles In Permission</a></li>
                    <li><a href="{{route('show.user')}}"><i class="ri-user-add-line"></i>Create New User</a></li>
