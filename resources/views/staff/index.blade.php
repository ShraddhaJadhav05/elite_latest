                ...
                <ul class="list-inline p-0 m-0">
                   <li class="d-flex mb-3 align-items-center p-3 sell-list border-primary rounded">
                      <div class="user-img img-fluid">
                         <img src="{{ asset('staffbackend/assets/images/elite-images/partners/partner1.png') }}" alt="story-img" class="img-fluid recommended_bank">
                      </div>
                   ...
                   <li class="d-flex mb-3 align-items-center p-3 sell-list border-primary rounded">
                      <div class="user-img img-fluid">
                         <img src="{{ asset('staffbackend/assets/images/elite-images/partners/partner2.png') }}" alt="story-img" class="img-fluid  recommended_bank">
                      </div>
                      <div class="media-support-info ml-3">
                   ...
                   <li class="d-flex mb-3 align-items-center p-3 sell-list border-primary rounded">
                      <div class="user-img img-fluid">
                         <img src="{{ asset('staffbackend/assets/images/elite-images/partners/partner3.png') }}" alt="story-img" class="img-fluid recommended_bank">
                      </div>
                      <div class="media-support-info ml-3">
                   ...
                   <li class="d-flex mb-3 align-items-center p-3 sell-list border-primary rounded">
                      <div class="user-img img-fluid">
                         <img src="{{ asset('staffbackend/assets/images/elite-images/partners/partner4.png') }}" alt="story-img" class="img-fluid  recommended_bank">
                      </div>
                      <div class="media-support-info ml-3">
