      ...
      <div class="new-user-info">
         ...
         @csrf
            ...
            <div class="row">
               ...
               <div class="form-group col-md-6">
                  <label for="plan">Product Plan:<span style="color: red;"> *</span></label>
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" id="monthly_installment" placeholder="Monthly Installment" name="monthly_installment" autocomplete="off">
