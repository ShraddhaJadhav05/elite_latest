                  ...
                  <div class="iq-card">
                     ...
                     <div class="iq-card-body">
                        <div class="new-user-info">
                           <form id="addbranchForm" method="POST" action="{{ route('add.branch') }}" enctype="multipart/form-data">
                           @csrf
                              <div class="row">
                                 <div class="form-group col-md-6">
                                    <label for="branch_name">Branch Name</label>
                                    <input type="text" class="form-control" id="branch_name" placeholder="Branch Name" name="branch_name" autocomplete="off">
                                 </div>
                              </div>
