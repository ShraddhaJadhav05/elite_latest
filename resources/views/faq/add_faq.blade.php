...
@section('admin')
<form id="addLeadForm" method="POST" action="{{ route('faq.add') }}" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="iq-card-body">
                        <div class="new-user-info">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pname" placeholder="Question" name="question"  required>
                            </div>
                            <div class="form-group">
                                <label>Answer<sup>*</sup></label><br>
                                <textarea  class="form-control summernote" rows="6" cols="45" name="answer" placeholder="Answer" required></textarea>
                            </div>
                            <div class="form-group">
