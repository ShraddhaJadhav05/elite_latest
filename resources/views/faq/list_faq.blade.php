                    ...
                    <div class="table-responsive">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <a class="btn btn-primary" href="{{route('faq.add')}}" >
                                    Add New FAQ
                                    </a>
                                </div>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex align-items-center list-user-action">
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Show" href="{{ route('faq.view',['id' => $data['id']]) }}"><i class="ri-eye-line"></i></a>
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{route('faq.update',['id' => $data['id']])}}"><i class="ri-pencil-line"></i></a>
