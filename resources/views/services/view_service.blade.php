            ...
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between ">
                    ...
                    <div class="edit_block"> 
                        <div class="inner"><a class="btn btn-primary" href="{{route('service.updateService',['id' => $get_data->id])}}">Edit</a></div>
                    </div>
                </div>
                <div class="iq-card-body">
                    <div class="new-user-info">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pname" placeholder="Title" name="itle"  value="{{$get_data->title}}" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pname" placeholder="URL Key" name="url_key"  value="{{$get_data->url_key}}" readonly>
                        </div>
                    </div>
                </div>
            </div>
