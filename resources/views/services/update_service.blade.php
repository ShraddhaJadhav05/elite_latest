...
@section('admin')
<form id="addLeadForm" method="POST" action="{{ route('service.updateService',['id' => $get_data->id]) }}" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="iq-card-body">
                        <div class="new-user-info">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="pname" placeholder="URL Key" name="url_key"  value="{{$get_data->url_key}}" required>
                            </div>
                        </div>
                    </div>
                </div>
