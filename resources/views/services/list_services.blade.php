                    ...
                    <div class="table-responsive">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <a class="btn btn-primary" href="{{route('service.addService')}}" >
                                    Add New Service
                                    </a>
                                </div>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex align-items-center list-user-action">
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Show" href="{{ route('service.viewService',['id' => $data->id]) }}"><i class="ri-eye-line"></i></a>
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{route('service.updateService',['id' => $data->id])}}"><i class="ri-pencil-line"></i></a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{route('service.deleteServices')}}" method="post">
                    @csrf
