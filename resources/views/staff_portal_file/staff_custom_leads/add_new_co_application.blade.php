                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Co-Applicant</h4>
                        </div>
                     </div>
                     <div class="iq-card-body">
                        <div class="new-user-info">
                           <form id="addLeadForm" method="POST" action="{{ route('add.coapplicant.loan.application') }}">
                           @csrf
                            ...
                            <button type="submit" class="btn btn-primary" id="createLeaddBtn">Submit</button>
...
<script>
    $(document).ready(function() {
        ...
        $('#lead_type_co_applicant').prop('checked', true);
    });
</script>
