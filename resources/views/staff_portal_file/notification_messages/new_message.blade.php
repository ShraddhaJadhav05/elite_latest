        ...
        <div class="row">
            ...
            <div class="iq-card iq-border-radius-20">
                <div class="iq-card-body">
                    ...
                    <form id="emailForm" class="email-form" method="POST" action="{{ route('send.notification') }}" enctype="multipart/form-data">
                    @csrf                    
...
<script>
    ...
    $('#message, #inputEmail3').on('input change', clearErrors);
