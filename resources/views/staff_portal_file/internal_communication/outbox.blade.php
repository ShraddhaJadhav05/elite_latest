                ...
                <div class="">
                    <div class="iq-email-to-list p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <li data-toggle="tooltip" data-placement="top" title="Delete"><a href="{{ route('delete.all.outbox') }}" onclick="return confirm('Are you sure you want to delete all outbox messages?')"><i class="ri-delete-bin-line"></i></a></li>
                            </ul>
                            <div class="iq-email-search d-flex align-items-center">
                            <form class="mr-3 position-relative" id="searchForm" action="{{ route('show.outbox') }}" method="GET">
                            ...
                            <ul class="d-flex align-items-center">
                                ...
                                <li data-toggle="tooltip" data-placement="top"><a class="btn btn-primary message_compose w-auto" href="{{route('show.new.message')}}">New Message</a></li>
                            </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach($sentMessages as $message)
                                ...
                                <li>
                                    <div class="d-flex align-self-center">
                                        ...
                                        <li><a href="{{route('delete.outbox.message',$message->id)}}"><i class="ri-delete-bin-2-line"></i></a></li>
