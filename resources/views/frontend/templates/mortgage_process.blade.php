        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="let-contact-form with-main-color process_mg">
                    ...
                    <form method="POST" action="{{route('mortgageProcess')}}">
                        @csrf
                        <div class="row m-0">
                            ...
                            <div class="col-sm-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone_number" id="phone_number" required="" data-error="Please enter your number" class="form-control" placeholder="+971 987895564">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-lg-12">
                            ...
                            <div class="col-sm-12 col-lg-12">
                                <div class='form-group nationality_1'>
                            ...
                            <div class="col-sm-12 col-lg-12">
                                <div class='form-group'>
                                    <label for='status'>Residence Status</label>
                                    <div class="select-box process">
                                        <select id='status' name='residence_status' required>
                            ...
                            <div class="col-sm-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" name="address" id="address" class="form-control" required="" data-error="Please enter your address" placeholder=""></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <div class="let-contact-btn">
                                    ...
                                    <!-- <a href="getstarted-2.html" class="main-default-btn cnt_btn " style="pointer-events: all; cursor: pointer;">Continue</a> -->
