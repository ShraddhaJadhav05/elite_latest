...
(function(jQuery) {
    ...
    jQuery(document).ready(function() {
       ...
       -----------------------------------------------------------------------*/
        ...
        // jQuery(document).on('click', 'ul.iq-email-sender-list li', function(event) {
        ...
        jQuery(document).on('click', 'ul.iq-email-sender-list li', function(event) {
            if (!jQuery(event.target).is(':checkbox')) {
                ...
                if (listItem.find('.iq-social-media li').length > 1) {
                    console.log('------if')
                    listItem.next().addClass('show');
                } else {
                    console.log('------else')
                    listItem.next().addClass('show').css({
                        'height': 'auto', // Set height to auto
                        'max-height': 'none', // Set max-height to none if needed
                        'overflow': 'visible' // Set overflow to visible if needed
                        // Add any other styles needed to maintain the original size
                    });
                }
            } else {
                jQuery(this).next().removeClass('show');
