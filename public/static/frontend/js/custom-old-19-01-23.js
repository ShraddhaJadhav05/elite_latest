jQuery(
    (function ($) {
        ...
        $(".blog-style-slider1").owlCarousel({ loop: true, margin: 25, autoplay:true, nav: false, dots: true, responsive: { 0: { items: 2 }, 576: { items: 2 }, 768: { items: 3 }, 1024: { items: 4 }, 1200: { items: 4 } } });
